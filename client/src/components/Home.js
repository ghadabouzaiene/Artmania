...
const Home = () => {
  ...
  <div className="menu">
    <ul >
     { auth && auth.user ?  <Link className="menu-list" onClick={()=>Logout()}>LOGOUT</Link> :
     <span></span>
      }
    ...
    <div className="text">
      ...
      <p>Every Artist needs a space where they can share 
		...
		<br/><br/>
		{ auth.user && auth.user.role ==="admin" ?  <a href="/admin" >welcome admin! </a> 
		: <div></div> 
		}
     
    </div>
    <ul class="social">
      <li><a href="facebook.com"><img src="https://i.ibb.co/x7P24fL/facebook.png"  alt=""/></a></li>
      <li><a href="twitter.com"><img src="https://i.ibb.co/Wnxq2Nq/twitter.png"  alt=""/></a></li>
      <li><a href="instagram.com"><img src="https://i.ibb.co/ySwtH4B/instagram.png"  alt=""/></a></li>
    </ul>
  </section>
